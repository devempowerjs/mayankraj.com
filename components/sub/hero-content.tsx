      ...
      <div className="w-full flex flex-col gap-5 justify-center m-auto text-center md:text-start">
        ...
        >
          ...
          <h1 className="text-[12px] md:text-[13px] text-gray-200 font-semibold">
            Full-Stack Web Developer • Student Innovator • Open-Source Creator
          </h1>
        </motion.div>
        ...
        >
          Hi, I’m <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500">Mayank Raj</span> <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500">(@devempowerjs)</span>
        </motion.h1>
        ...
        >
          Bringing ideas to life through code, design, and innovation. I build seamless web experiences using modern technologies — from frontend design to backend logic.
        </motion.p>
